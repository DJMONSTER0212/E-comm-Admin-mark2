...
const EditUser = ({ user }) => {
    ...
    return (
        <Card className='lg:col-span-2 h-fit'>
            <CardHeader>
                <CardTitle size='lg'>Edit user details</CardTitle>
                <CardDescription>Edit account details of <span className='text-foreground font-medium'>{user.name + "'s"}</span> account.</CardDescription>
