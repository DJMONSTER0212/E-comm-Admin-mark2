...
const TourCancellationRules = ({ tour }) => {
    ...
    return (
        <>
            <Card>
                ...
                <CardContent>
                    {tour.cancellationRules.length > 0 ? <div className={"grid grid-cols-1 gap-3 mb-5"}>
                        {tour.cancellationRules.map((rule) => (
            ...
            <AddCancellationRule open={isAddCancellationRuleOpen} setOpen={setIsAddCancellationRuleOpen} tour={tour} />
            {selectedCancellationRule && <EditCancellationRule open={isEditCancellationRuleOpen} setOpen={setIsEditCancellationRuleOpen} tour={tour} cancellationRule={selectedCancellationRule} />}
            {selectedCancellationRule && <DeleteCancellationRuleDialog open={isDeleteCancellationRuleDialogOpen} setOpen={setIsDeleteCancellationRuleDialogOpen} tour={tour} cancellationRule={selectedCancellationRule} />}
        </>
    )
}

export default TourCancellationRules