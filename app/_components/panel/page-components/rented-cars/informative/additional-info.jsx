...
const RentedCarAdditionalInfo = ({ rentedCar }) => {
    ...
    return (
        <Card>
            ...
            <CardContent>
                {rentedCar.additionalInfo.length > 0 ? <div className={"grid grid-cols-1 items-start gap-3 mb-5"}>
                    {rentedCar.additionalInfo.map((info, index) => (
                ...
                <AddAdditionalInfo rentedCar={rentedCar} />
                {selectedAdditionalInfo && <EditAdditionalInfo open={isEditAdditionalInfoOpen} setOpen={setIsEditAdditionalInfoOpen} rentedCar={rentedCar} additionalInfo={selectedAdditionalInfo} />}
                {selectedAdditionalInfo && <DeleteAdditionalInfoDialog open={isDeleteAdditionalInfoDialogOpen} setOpen={setIsDeleteAdditionalInfoDialogOpen} rentedCar={rentedCar} additionalInfo={selectedAdditionalInfo} />}
            </CardContent>
        </Card>
    )
}

export default RentedCarAdditionalInfo