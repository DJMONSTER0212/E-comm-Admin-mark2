...
const AddInclude = ({ open, setOpen, rentedCar, side }) => {
    ...
    // Rented car include item add function
    const { mutate: addInclude, isPending: isAddIncludePending, isSuccess: isAddIncludeSuccess, error: addIncludeError } = useMutation({
        mutationFn: async (formData) => {
            try {
                const { data } = await axios.post(`/api/panel/rented-cars/${rentedCar._id}/includes/`, formData)
                return data;
            } catch (error) {
