...
import { Clock1, MapPin, MapPinned, MoreVertical, Users } from 'lucide-react'
    ...
    return (
        <div className="relative flex flex-col lg:grid lg:grid-cols-3 gap-3 lg:gap-5 lg:justify-between items-start shadow-sm border rounded-md p-2 lg:p-3 focus-visible:ring-1 focus-visible:outline-0 focus-visible:ring-ring">
            <div className="rounded-md relative flex flex-col justify-between h-full">
                <Image src='/ds.jpg' alt='tour' width={400} height={400} quality={30} className='aspect-[3/2] h-full object-cover group-hover:scale-105 transition-all rounded-md' />
            ...
            <div className="flex flex-col w-full gap-3 lg:gap-2 justify-between lg:h-full lg:col-span-2">
                <div className="flex gap-5 justify-between">
                    <div className="flex flex-col">
                        <BorderLink href='/' className='lg:text-lg font-semibold hover:font-semibold focus-visible:font-semibold mt-1'>Jaisalmer: Red Dunes Desert Safari and Camel ride</BorderLink>
                ...
                <div className="flex flex-col gap-2 w-full">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 bg-muted rounded-md p-3">
                        <div className="flex flex-col">
                            <p className='uppercase text-xs text-muted-foreground font-medium mb-1.5 flex items-center gap-2'><MapPin className="w-3 h-3" /><span className='text-foreground font-semibold'>Starts at 3 AM</span> From</p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
                        <div className="flex flex-col bg-muted rounded-md p-3">
                            <p className='uppercase text-xs text-muted-foreground font-medium mb-1.5 flex items-center gap-2'><Users className='w-3 h-3' /> Shared tour</p>
                            <p className="ml-5 flex gap-3 items-center text-xs lg:font-medium text-foreground">
                                Booked for 12 Persons
                            </p>
                        </div>
                        <div className="flex flex-col bg-muted rounded-md p-3">
                            <p className='uppercase text-xs text-muted-foreground font-medium mb-1.5 flex items-center gap-2'><Clock1 className="w-3 h-3" /> Duration</p>
                            <p className="ml-5 flex gap-3 items-center text-xs lg:font-medium text-foreground">
                                3 Days
                            </p>
                        </div>
                        <div className="flex flex-col bg-muted rounded-md p-3">
                            <p className='uppercase text-xs text-muted-foreground font-medium mb-1.5 flex items-center gap-2'><Clock1 className="w-3 h-3" /> Start time</p>
                            <p className="ml-5 flex gap-3 items-center text-xs lg:font-medium text-foreground">
                                Start at 3 AM
                            </p>
                        </div>
