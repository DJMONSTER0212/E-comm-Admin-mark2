...
export const otpMailTemplates = [
  {
    ...
    image: '/panel/images/mail-temp-1.png',
    body: (otp, recipient, settings) => `<!DOCTYPE html>
        <html>
        <head>
            <meta charset="UTF-8">
        ...
        <body>
            ...
            <tr>
                <td class="logo">
                <img src="${settings.general.lightLogo}" alt="${settings.general.name}" style="max-width: 30%;">
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td class="footer">
                <p>&copy; 2023 ${settings.general.name}. All rights reserved. | <a href="${process.env.BASE_URI}">Visit our website</a></p>
                </td>
            </tr>
            </table>
        </body>
  ...
  },
  {
    ...
    image: '/panel/images/mail-temp-2.png',
    body: (otp, recipient, settings) => `<!DOCTYPE html>
        <html>
          <head>
            <meta charset="utf-8">
                      ...
                      <tbody>
                        <tr>
                          <td align="center" style="padding: 40px;">
                            <img src="${settings.general.lightLogo}" alt="${settings.general.name}" width="100" height="100">
                            <h1 style="font-size: 24px; margin: 20px 0;">Verify your email address</h1>
                            <p style="font-size: 16px; margin: 20px 0;">Hi ${recipient.name},</p>
                            <p style="font-size: 16px; margin: 20px 0;">Thank you for signing up for ${settings.general.name}. To complete your registration, please enter the following OTP:</p>
                            <table cellpadding="0" cellspacing="0" border="0" width="200" bgcolor="${primaryColor}" style="border-radius: 4px;">
                              <tbody>
                                <tr>
                                  <td align="center" style="padding: 10px;">
                                    <span style="font-size: 20px; color: #ffffff; font-weight: bold;">${otp}</span>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                            ...
                            <p style="font-size: 16px; margin: 20px 0;">${settings.general.name} Team</p>
                          </td>
                        </tr>
                      </tbody>
                    </table>
